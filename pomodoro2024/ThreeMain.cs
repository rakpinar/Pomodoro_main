...
{
    [Activity(Label = "TYT  Denemeleri", Theme = "@style/AppTheme")]
    public class ThreeMain : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_three_main);
            ...
            if (button3 != null) button3.Click += (sender, e) => StartTimer(10); // 10 dakika
        }
