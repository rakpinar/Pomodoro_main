...
{
    [Activity(Label = "Ayt Genel Deneme", Theme = "@style/AppTheme")]
    public class AytGenelDeneme : AppCompatActivity
    {
        private Button startTimerButton;
        private CountdownTimerView countdownTimerView;
        private Timer timer;
        private int remainingTimeInSeconds = 10 * 60; // 10 dakika süre

        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.AytGenelDenemeMain);
